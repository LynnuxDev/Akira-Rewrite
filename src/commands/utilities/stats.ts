...
import { ActionRow, ActionRowBuilder, ButtonBuilder, ButtonStyle, ChatInputCommandInteraction, EmbedBuilder, SlashCommandBuilder, Status } from "discord.js";

export default {
  data: new SlashCommandBuilder()
    .setName('stats')
    .setDescription('View akira\'s stats.'),
  ...
  async execute(
    ...
    try {
      ...
      const message = 'Error: Failed to reply.'
